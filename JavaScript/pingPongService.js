...
// There's no need to check if the passed parameter is valid - 
// the score will be always provided in correct syntax and you don't need 
// to check if one of the players has already won - that won't be the case.
...
function service(score) {
    let game = score.split(':');
    let totalScore = parseInt(game[0]) + parseInt(game[1]);
